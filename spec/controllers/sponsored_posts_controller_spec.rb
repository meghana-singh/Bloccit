...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  let(:my_sponsored_post) { my_topic.sponsored_posts.create!(title: RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.rand_data) }
 ...
 # #4
      it "increases the number of SponsoredPost by 1" do
        ...
        expect{post :create, topic_id: my_topic.id, sponsored_post: {title: RandomData.random_sentence, body: RandomData.random_paragraph, pricec: RandomData.rand_data}}.to change(SponsoredPost,:count).by(1)
      end
 
 # #5
      it "assigns the new sponsored_post to @sponsored_post" do
        
        post :create, topic_id: my_topic.id, sponsored_post: {title: RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.rand_data}
 ...
 # #2
    ...
    describe "PUT update" do
     it "updates sponsored_post with expected attributes" do
       ...
       new_price = RandomData.rand_data
